...
export const promotionTemplates: PromotionTemplate[] = [
  ...
  item({ id: "poster.product.features", name: "产品能力", category: "product", categoryLabel: "产品推广", background: "#EEF2FF", primaryColor: "#5D5FEF", secondaryColor: "#132A77", title: "一套平台，释放团队AI生产力", subtitle: "从灵感到作品，流程更清晰", badge: "核心能力", description: "能力卡片与产品亮点", featureItems: ["图片与视频", "PPT与自由P图", "AI员工"], layout: "feature-grid" }),
