  ...
  <view class="mpb-page" :style="miniProgramNavigationStyle">
    ...
    <template v-else-if="detail">
      <view class="result-preview">
        ...
        <view v-else-if="comparison" class="detail-comparison">
...
.result-preview{position:relative;height:410px;background:#e9edf5}.result-preview video{width:100%;height:100%}.detail-comparison{display:grid;width:100%;height:100%;grid-template-columns:1fr 1fr;gap:1px;background:#fff}.detail-comparison>view{position:relative;min-width:0;height:100%;overflow:hidden}.detail-comparison>view>text{position:absolute;z-index:3;right:12px;bottom:12px;padding:5px 8px;border-radius:5px;color:#fff;background:rgba(18,24,43,.72);font-size:10px}.ai-badge{position:absolute;z-index:4;right:14px;top:14px;bottom:auto;padding:6px 9px;border-radius:5px;color:#fff;background:rgba(18,24,43,.72);font-size:10px}
