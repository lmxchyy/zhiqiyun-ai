...
function openCustomer(item: AnyRecord) { const id = rowString(item, "userId", "customerId", "buyerUserId"); if (id) uni.navigateTo({ url: `/pages/agent/AgentCustomerDetailPage?id=${encodeURIComponent(id)}` }); }
