...
import { openLegalDocument, type LegalDocumentCode } from "../../features/legal/navigation";
...
function openOrderAgreement() { let code: LegalDocumentCode = "member-service-agreement"; if (normalizedPlanType.value.includes("recharge")) code = "recharge-service-agreement"; else if (normalizedPlanType.value.includes("agent")) code = "agent-service-agreement"; else if (normalizedPlanType.value.includes("operation")) code = "enterprise-space-service-agreement"; openLegalDocument(code); }
