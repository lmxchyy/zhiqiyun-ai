...
<style>@import "../../styles/mini-program-business.css"; .mpb-guest{margin:0 16px 12px;padding:14px}.mpb-guest-button{margin-top:10px;border:0;border-radius:12px;background:#4a6bff;color:#fff;font-size:14px}.mpb-guest-button::after{display:none}</style>
