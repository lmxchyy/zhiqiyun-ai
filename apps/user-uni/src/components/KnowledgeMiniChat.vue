...
async function stopGeneration() { runHandle?.abort(); if (activeRunId.value) { try { await miniKnowledgeAPI.cancel(activeRunId.value); } catch {} } generating.value = false; }
