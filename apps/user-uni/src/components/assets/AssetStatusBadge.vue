...
const labels: Record<string, string> = { recent: "最近", queued: "排队中", generating: "生成中", running: "生成中", cancel_requested: "取消中", completed: "已完成", failed: "失败", expired: "已超时", manual_review: "人工审核中", unknown: "处理中", favorite: "收藏", archived: "已归档", recycled: "回收站", cancelled: "已取消" };
const label = computed(() => labels[props.status] || "处理中");
const tone = computed(() => ({ queued: "queued", generating: "primary", running: "primary", cancel_requested: "queued", unknown: "queued", completed: "success", failed: "danger", expired: "danger", manual_review: "queued", favorite: "favorite", archived: "muted", recycled: "recycled", cancelled: "muted", recent: "muted" } as Record<string, string>)[props.status] || "muted");
</script>
<style scoped>
