...
export const billingApi = {
  ...
  publishRule: (id: string, payload?: { confirmNegativeMargin?: boolean }) => adminRequest<{ item: BillingRuleVersion }>({ method: "POST", url: `/admin/billing/rules/${id}/publish`, data: payload }),
