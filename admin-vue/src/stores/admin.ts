...
export const adminModules: AdminModule[] = [
  ...
  { id: "operationCenterDashboard", title: "运营中心看板", endpoint: "/operation-center/profile" },
  { id: "operationCenterAgents", title: "代理商管理", endpoint: "/operation-center/agents" },
  { id: "operationCenterOrders", title: "订单归属", endpoint: "/operation-center/orders" },
  { id: "operationCenterCommissions", title: "分润明细", endpoint: "/operation-center/commissions" },
  { id: "enterpriseList", title: "企业列表", endpoint: "" },
  { id: "enterpriseDetail", title: "企业详情", endpoint: "" },
  { id: "enterpriseCertifications", title: "认证审核", endpoint: "" },
  { id: "enterpriseMembers", title: "成员与组织", endpoint: "" },
  { id: "enterprisePackage", title: "套餐与席位", endpoint: "" },
  { id: "enterpriseCompute", title: "算力账户", endpoint: "" },
  { id: "enterpriseTransactions", title: "充值消费明细", endpoint: "" },
  { id: "enterpriseOrders", title: "企业订单", endpoint: "" },
  { id: "enterpriseAiCapabilities", title: "模型与 AI 能力", endpoint: "" },
  { id: "enterpriseAiEmployees", title: "AI 员工", endpoint: "" },
  { id: "enterpriseKnowledgeBases", title: "知识库概览", endpoint: "" },
  { id: "enterpriseAttribution", title: "客户归属", endpoint: "" },
  { id: "enterpriseRelationships", title: "渠道关系", endpoint: "" },
  { id: "enterpriseRisk", title: "风控与禁用", endpoint: "" },
  { id: "enterpriseAuditLogs", title: "审计日志", endpoint: "" },
  ...
  { id: "customerAttributions", title: "客户归属总览", endpoint: "" },
  ...
  { id: "billingOverview", title: "计费总览", endpoint: "/admin/billing/overview" },
  { id: "billingRules", title: "模型计费规则", endpoint: "/admin/billing/rules" },
  { id: "billingProviderCosts", title: "供应商成本", endpoint: "/admin/billing/provider-costs" },
  { id: "billingEvents", title: "计费事件", endpoint: "/admin/billing/events" },
  { id: "billingReconciliation", title: "任务对账", endpoint: "/admin/billing/reconciliation" },
  { id: "billingWalletLedger", title: "钱包流水", endpoint: "/admin/billing/wallet-ledger" },
  ...
  { id: "billingInvoices", title: "发票与账单", endpoint: "/admin/billing/invoices" },
  { id: "billingCreditNotes", title: "贷项红冲", endpoint: "/admin/billing/credit-notes" },
  { id: "billingPaymentRequests", title: "付款请求与催收", endpoint: "/admin/billing/payment-requests" },
  { id: "billingPayments", title: "支付记录", endpoint: "/admin/billing/payments" },
  ...
  { id: "mediaAssets", title: "素材中心", endpoint: "" },
  { id: "pageDecoration", title: "页面装修", endpoint: "" },
  { id: "pageHomeConfig", title: "首页配置", endpoint: "" },
  { id: "pageStudioConfig", title: "创作页配置", endpoint: "" },
  { id: "pageAssetsConfig", title: "作品页配置", endpoint: "" },
  { id: "pageProfileConfig", title: "我的页配置", endpoint: "" },
  { id: "mediaCategories", title: "素材分类", endpoint: "" },
  { id: "storageCenter", title: "对象存储", endpoint: "" },
