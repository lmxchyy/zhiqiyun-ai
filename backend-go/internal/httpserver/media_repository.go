...
func defaultPageAssetSlots() []pageAssetSlot {
	specs := [][5]string{
		...
		{"home", "capability", "home.capability.ai_design", "能力-AI设计", "AI 设计能力"}, {"home", "capability", "home.capability.ai_video", "能力-AI视频", "AI 视频能力"}, {"home", "capability", "home.capability.ppt", "能力-PPT", "AI PPT 能力"}, {"home", "capability", "home.capability.office", "能力-AI办公", "AI 办公能力"}, {"home", "capability", "home.capability.knowledge", "能力-知识库", "知识库能力"}, {"home", "capability", "home.capability.employee", "能力-AI员工", "AI 员工能力"},
