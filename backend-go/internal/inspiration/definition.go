// Package inspiration holds the platform-agnostic core of the inspirations
// domain: template definition validation, deterministic prompt composition,
// public projection, and signed creation drafts. It depends only on the Go
// standard library so it can later be consumed by services beyond httpserver;
// the HTTP layer keeps living in internal/httpserver behind thin bridges.
package inspiration
